...
public class TestPlugin: NSObject, FlutterPlugin, HostIntegrationCoreApi {
  ...
  public func echo(_ anInt: Int32) -> Int32 {
    return anInt
  }
  ...
  public func sendMultipleNullableTypes(aBool aNullableBool: Bool?, anInt aNullableInt: Int32?, aString aNullableString: String?) -> AllNullableTypes {
    let someThings = AllNullableTypes(aNullableBool: aNullableBool, aNullableInt: aNullableInt, aNullableString: aNullableString)
    return someThings
  }

  public func echo(_ aNullableInt: Int32?) -> Int32? {
    return aNullableInt
  }
  ...
  public func echoAsync(_ anInt: Int32, completion: @escaping (Result<Int32, Error>) -> Void) {
  ...
  public func echoAsyncNullable(_ anInt: Int32?, completion: @escaping (Result<Int32?, Error>) -> Void) {
    completion(.success(anInt))
  }
  ...
  public func callFlutterEcho(_ anInt: Int32, completion: @escaping (Result<Int32, Error>) -> Void) {
  ...
  public func callFlutterEchoNullable(_ anInt: Int32?, completion: @escaping (Result<Int32?, Error>) -> Void) {
