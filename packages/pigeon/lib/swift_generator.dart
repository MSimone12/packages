...
''');
  ...
  void writeClassDecode(
    ...
    indent.write('public static func fromList(_ list: [Any?]) -> $className? ');
      ...
      for (final Method func in api.methods) {
        ...
        if (func.arguments.isEmpty) {
          ...
          if (func.returnType.isVoid) {
            indent.write(
                'public func ${components.name}($argsSignature, completion: @escaping () -> Void) ');
          } else {
            indent.write(
                'public func ${components.name}($argsSignature, completion: @escaping ($returnType) -> Void) ');
          }
        }
        indent.addScoped('{', '}', () {
